...
def mix(mix_count, multiplier):
    ...
    return sum(number_list[(zi + i) % len(number_list)][1] for i in range(1000, 3001, 1000))

print("D20P1:", mix(1, 1))
print("D20P2:", mix(10, KEY))
